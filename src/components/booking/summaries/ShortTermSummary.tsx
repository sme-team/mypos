 ...
 */
export const ShortTermSummary = React.memo(
  ({
    form,
    room,
    selectedCustomer,
    ...
    const [priceResult, setPriceResult] = useState<ShortTermPriceResult | null>(
      null,
    );
      ...
      <ScrollView
        ...
        <View style={styles.summaryContent}>
          ...
          <View style={styles.summarySectionHeader}>
            <Text
              style={[styles.summarySectionTitle, {color: themedColors.text}]}>
              {t('booking.sections.room')}
            </Text>
          </View>
          <View
            style={[
              styles.summaryRoomCard,
              {
            ...
            <View style={styles.summaryRoomInfo}>
              <Text
                style={[styles.summaryRoomTag, {color: themedColors.primary}]}>
                {t('booking.sections.room')}
              </Text>
              <Text
                style={[styles.summaryRoomName, {color: themedColors.text}]}>
                {room.label}
              </Text>
              <Text
                style={[
                  styles.summaryRoomAddr,
          ...
          <View style={styles.summarySectionHeader}>
            ...
            <TouchableOpacity onPress={onEdit}>
              <Text
                style={[styles.summaryEditBtn, {color: themedColors.primary}]}>
          ...
          <View
            style={[
              styles.summaryCustomerCard,
              {backgroundColor: themedColors.primaryLight},
            ]}>
            <View
              style={[
                styles.summaryCustomerAvatar,
          ...
          <View
            ...
            <View style={styles.summaryGridRow}>
              <View style={styles.summaryGridItem}>
                ...
                <Text
                  style={[styles.summaryGridValue, {color: themedColors.text}]}>
                  {form.checkinDate}
                </Text>
          ...
          <View
            style={[
              styles.summaryTotalCard,
              {backgroundColor: themedColors.primaryLight},
            ]}>
            <Text
              style={[styles.summaryTotalTitle, {color: themedColors.text}]}>
            ...
            <View
              ...
              <Text
                style={[
                  styles.confSummaryGrandTotalLabel,
                  {color: themedColors.text},
                ]}>
              ...
              <Text
                style={[
                  styles.confSummaryGrandTotalValue,
                  {color: themedColors.primary},
                ]}>
